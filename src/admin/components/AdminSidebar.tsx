  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-[#143D36] space-y-2">
          <Link
            to="/"
            className="w-full flex items-center justify-between px-4 py-2.5 rounded-xl text-xs font-semibold text-[#C89B7B] hover:bg-[#143D36] transition-colors"
          >
            <span className="flex items-center gap-2">
              <ExternalLink className="w-4 h-4" /> Live Website
            </span>
            <span className="text-[10px] bg-[#143D36] px-2 py-0.5 rounded-md">Visit</span>
          </Link>
